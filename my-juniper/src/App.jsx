...
import Logo from '../src/assets/img/logoh.png'
import Buscar from '../src/assets/img_icon/buscar.png'
import User from '../src/assets/img_icon/user.png'

function App() {

  return (
    <body class="bg-[#E68C3A]">

        {/* Header home principal */}
        <header
            class="bg-[#F4F2EF] h-32 w-[100%] flex items-center space-x-16 //justify-between  ">
